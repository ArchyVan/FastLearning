...
- (NSString *)ar_to16MD5 {
    ...
    return [[self ar_toMD5] substringWithRange:NSMakeRange(8, 16)];
}
...
- (BOOL)ar_isEmail {
    return [NSString ar_isEmail:self];
}
...
- (BOOL)ar_isMobilePhone {
    return [NSString ar_isMobilePhone:self];
}
...
- (BOOL)ar_isTelNumber {
    return [NSString ar_isTelNumber:self];
}
...
- (BOOL)ar_isPersonID {
    return [NSString ar_isPersonID:self];
}
...
- (NSString *)ar_trim {
    NSString *str = [self ar_trimLeft];
    return [str ar_trimRight];
}
...
- (NSString *)ar_filterHtml {
    return [NSString ar_filterHTML:self];
}
