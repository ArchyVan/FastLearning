...
class AnimatingChangesViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        timer = Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(AnimatingChangesViewController.updateViews(_:)), userInfo: nil, repeats: false)
    }
        ...
        UIView.animate(withDuration: 0.25, animations: { [unowned self] in
            ...
            */
            ...
            self.view.layoutIfNeeded()
                ...
                Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(AnimatingChangesViewController.updateViews(_:)), userInfo: nil, repeats: false)
        })
    }
