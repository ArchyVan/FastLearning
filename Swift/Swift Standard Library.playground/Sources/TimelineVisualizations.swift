...
private func showTimelineCollection(_ elements: [(date: String, image: UIImage?)]) -> UIView {
...
public func visualize<C: Collection>(_ collection: C) -> UIView where C.Iterator.Element == UIImage? {
